      ...
      <body>
        <div class="print-container">
          ...
          <div style="text-align:center; margin-bottom: 1.5rem;">
            <span style="font-size:1.3rem; font-weight:700; color:#ea580c; letter-spacing:1px;">Filial: São João de Miriti - RJ</span>
          </div>
...
document.addEventListener('DOMContentLoaded', function() {
  console.log('DOM carregado - inicializando dashboard vilar');
  ...
  console.log('Dashboard Vilar inicializado com sucesso');
